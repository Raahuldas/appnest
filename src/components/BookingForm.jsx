        ...
        <div className="row align-items-center g-lg-5 py-5 ">
          ...
          <div className="col-md-10 mx-auto col-lg-6">
            <form className="form-css py-4 borde rounded-3 bg-black px-4 mx-lg-auto mt-5 mt-lg-0">
              ...
              <div className="form-floating mb-3 border-bottom border-1">
                <select className="form-select border-0 bg-black text-light" aria-label="Default select example">
                  <option className="bg-light text-dark" defaultValue>Select a Budget Range</option>
              ...
              <button className="w-100 btn btn-lg btn-dark bg-black-subtle mt-4" type="submit">
                Request Proposal
              </button>
            </form>
          </div>
