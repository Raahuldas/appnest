    ...
    <div class="container px-4 py-5" id="featured-3">
      ...
      <div class="row g-4 py-5 row-cols-1 row-cols-lg-3 text-center">
        ...
        <div class="feature col-12 col-md-4 px-3">
          ...
          <h3 class="fs-5 text-body-emphasis">Written/Technical</h3>
          <p>
        ...
        <div class="feature col-12 col-md-4 px-3">
          ...
          <h3 class="fs-5 text-body-emphasis">Personal Interview</h3>
          <p>
        ...
        <div class="feature col-12 col-md-4 px-3">
          ...
          <h3 class="fs-5 text-body-emphasis">HR Discussion</h3>
          <p>
        ...
        <div class="feature col-12 col-md-4 px-3">
          ...
          <h3 class="fs-5 text-body-emphasis">Final Review</h3>
          <p>
