      ...
      <div class="album py-5 ">
        <div class="container">
          <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
            ...
            <div class="col">
              <div class="card shadow-sm bg-dark text-light px-5 card-css">
            ...
            <div class="col">
              <div class="card shadow-sm bg-dark text-light px-5">
                <div className="card-title fs-1 ">
                  <TbDeviceMobileCog/>
                </div>
            ...
            <div class="col">
              <div class="card shadow-sm bg-dark text-light px-5 card-css">
                ...
                <div class="card-body px-0 ">
                  <p class="card-text fs-5 ">Ideation a& Design Strategy</p>
                  <div class="d-flex justify-content-between align-items-center">
